...
/* Superblock (1024 bytes, offset 1024) */
...
#define EXT4_FEATURE_INCOMPAT_DIRDATA      0x0800
...
struct ext4_group_desc {
    ...
    /* 64-bit fields follow if 64bit feature */
...
struct ext4_inode {
    ...
    uint32_t i_flags;
    uint32_t i_osd1;
    uint8_t  i_block[60];   /* extent tree or block pointers */
...
#define EXT4_INODE_SIZE        128   /* Old ext2 size */
#define EXT4_INODE_SIZE_EXT4   256   /* Modern ext4 size */

/* Inode flags */
#define EXT4_INDEX_FL          0x00001000  /* Directory uses hash index */
